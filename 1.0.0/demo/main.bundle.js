...
var CloukitNotificationComponent = (function () {
    ...
    CloukitNotificationComponent.prototype.notificationTypeToUiModifier = function (type) {
        if (type === __WEBPACK_IMPORTED_MODULE_1__notification_model__["c" /* CloukitNotificationType */].ERROR)
            return 'error';
        if (type === __WEBPACK_IMPORTED_MODULE_1__notification_model__["c" /* CloukitNotificationType */].INFO)
            return 'info';
        if (type === __WEBPACK_IMPORTED_MODULE_1__notification_model__["c" /* CloukitNotificationType */].WARN)
            return 'warn';
        if (type === __WEBPACK_IMPORTED_MODULE_1__notification_model__["c" /* CloukitNotificationType */].SUCCESS)
            return 'success';
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return CloukitNotificationType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CloukitNotificationLink; });
var CloukitNotification = (function () {
    function CloukitNotification(title, message, type, linkOne, linkTwo) {
        this.title = title;
...
var CloukitNotificationLink = (function () {
    function CloukitNotificationLink(title, event) {
        this.title = title;
        this.event = event;
    }
...
var CloukitNotificationComponentThemeDefault = (function (_super) {
    ...
    function CloukitNotificationComponentThemeDefault() {
        ...
        _this.createStyle('wrapper', 'fadeOut', 'latest', _this.merge(_this.getStyle('wrapper', 'fadeIn', 'latest'), {
            style: {}
        }));
        //
        // notification
...
var CloukitNotificationService = (function () {
    ...
    CloukitNotificationService.prototype.setOutletTemplate = function (t, placement) {
        ...
        request.zIndex = 300;
        var dropoutRef = self.dropoutService.requestDropoutCreation(request);
        // FIXME: destroy
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_demo_stories_story_00_simple_notifications__ = __webpack_require__("../../../../../src/demo/stories/story-00-simple-notifications.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    DemoModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8_demo_stories_story_00_simple_notifications__["a" /* Story00Component */],
            ],
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__index__["c" /* CloukitNotificationModule */],
...
var Story00Component = (function () {
    ...
    Story00Component.prototype.addNotification = function () {
        var random = this._randomInt(0, 6);
        var event = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["t" /* EventEmitter */]();
        event.subscribe(function () {
            console.log('you clicked');
        });
        var dummyNotification;
        if (random === 0)
            dummyNotification = new __WEBPACK_IMPORTED_MODULE_2__index__["a" /* CloukitNotification */]('Atención', 'Los pantalones estan pequeños', __WEBPACK_IMPORTED_MODULE_2__index__["e" /* CloukitNotificationType */].WARN, new __WEBPACK_IMPORTED_MODULE_2__index__["b" /* CloukitNotificationLink */]('foo', event), null);
        if (random === 1)
            dummyNotification = new __WEBPACK_IMPORTED_MODULE_2__index__["a" /* CloukitNotification */]('Note', 'You should drink 2-3 liters a day', __WEBPACK_IMPORTED_MODULE_2__index__["e" /* CloukitNotificationType */].INFO, new __WEBPACK_IMPORTED_MODULE_2__index__["b" /* CloukitNotificationLink */]('Tell me more', event), new __WEBPACK_IMPORTED_MODULE_2__index__["b" /* CloukitNotificationLink */]('naaaah', event));
        if (random === 2)
            dummyNotification = new __WEBPACK_IMPORTED_MODULE_2__index__["a" /* CloukitNotification */]('Warn', 'Sugar is unhealthy!', __WEBPACK_IMPORTED_MODULE_2__index__["e" /* CloukitNotificationType */].ERROR, null, null);
        if (random === 3)
            dummyNotification = new __WEBPACK_IMPORTED_MODULE_2__index__["a" /* CloukitNotification */]('Info', 'Sport is healthy.', __WEBPACK_IMPORTED_MODULE_2__index__["e" /* CloukitNotificationType */].INFO, null, null);
        if (random === 4)
            dummyNotification = new __WEBPACK_IMPORTED_MODULE_2__index__["a" /* CloukitNotification */]('Success', 'You clicked a button!', __WEBPACK_IMPORTED_MODULE_2__index__["e" /* CloukitNotificationType */].SUCCESS, new __WEBPACK_IMPORTED_MODULE_2__index__["b" /* CloukitNotificationLink */]('foo', event), null);
        if (random === 5)
            dummyNotification = new __WEBPACK_IMPORTED_MODULE_2__index__["a" /* CloukitNotification */]('Ok', 'all fine!', __WEBPACK_IMPORTED_MODULE_2__index__["e" /* CloukitNotificationType */].SUCCESS, new __WEBPACK_IMPORTED_MODULE_2__index__["b" /* CloukitNotificationLink */]('foo', event), null);
        this.notificationService.addNotification(dummyNotification);
    };
    Story00Component.prototype._randomInt = function (min, max) {
        min = Math.ceil(min);
        max = Math.floor(max);
        return Math.floor(Math.random() * (max - min)) + min;
    };
    Story00Component = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__index__["d" /* CloukitNotificationService */]])
    ], Story00Component);
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_0__components_notification_module__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_1__components_notification_model__["c"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_2__components_services_notification_service__["a"]; });
